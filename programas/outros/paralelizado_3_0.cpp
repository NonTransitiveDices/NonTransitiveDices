...
main()
{
    ...
    for(int n = 10; n <= 15; n++)
    {
        ...
        int numABC[][3] = {
            {n-6, n, n    }, {n-5, n-1, n  },
            {n-5, n-1, n  }, {n-4, n-2, n  },
            {n-4, n-1, n-1}, {n-5, n-1, n  },
            {n-4, n-2, n  }, {n-4, n-1, n-1},
            {n-4, n-2, n  }, {n-3, n-3, n  },
            {n-3, n-2, n-1}, {n-4, n-1, n-1},
            {n-3, n-2, n-1}, {n-3, n-1, n-2},
            {n-5, n-1, n  }, {n-4, n-2, n  },
            {n-4, n-1, n-1}, {n-4, n-2, n  },
            {n-3, n-3, n  }, {n-3, n-2, n-1},
            {n-4, n-1, n-1}, {n-3, n-2, n-1},
            {n-3, n-1, n-2}, {n-4, n-2, n  },
            {n-3, n-3, n  }, {n-3, n-2, n-1},
            {n-3, n-3, n  }, {n-2, n-4, n  },
            {n-2, n-3, n-1}, {n-3, n-2, n-1},
            {n-2, n-3, n-1}, {n-2, n-2, n-2},
            {n-4, n-1, n-1}, {n-3, n-2, n-1},
            {n-3, n-1, n-2}, {n-3, n-2, n-1},
            {n-2, n-3, n-1}, {n-2, n-2, n-2},
            {n-3, n-1, n-2}, {n-2, n-2, n-2},
            {n-2, n-1, n-3}, {n-5, n-1, n  },
            {n-4, n-2, n  }, {n-4, n-1, n-1},
            {n-4, n-2, n  }, {n-3, n-3, n  },
            {n-3, n-2, n-1}, {n-4, n-1, n-1},
            {n-3, n-2, n-1}, {n-3, n-1, n-2},
            ...
            {n-2, n-4, n  }, {n-2, n-3, n-1},
            {n-3, n-2, n-1}, {n-2, n-3, n-1},
            {n-2, n-2, n-2}, {n-4, n-1, n-1},
            {n-3, n-2, n-1}, {n-3, n-1, n-2},
            {n-3, n-2, n-1}, {n-2, n-3, n-1},
            {n-2, n-2, n-2}, {n-3, n-1, n-2},
            {n-2, n-2, n-2}, {n-2, n-1, n-3},
            {n-4, n-2, n  }, {n-3, n-3, n  },
            {n-3, n-2, n-1}, {n-3, n-3, n  },
            {n-2, n-4, n  }, {n-2, n-3, n-1},
            {n-3, n-2, n-1}, {n-2, n-3, n-1},
            {n-2, n-2, n-2}, {n-3, n-3, n  },
            {n-2, n-4, n  }, {n-2, n-3, n-1},
            {n-2, n-4, n  }, {n-1, n-5, n, },
            {n-1, n-4, n-1}, {n-2, n-3, n-1},
            {n-1, n-4, n-1}, {n-1, n-3, n-2},
            {n-3, n-2, n-1}, {n-2, n-3, n-1},
            {n-2, n-2, n-2}, {n-2, n-3, n-1},
            {n-1, n-4, n-1}, {n-1, n-3, n-2},
